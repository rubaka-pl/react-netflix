            ...
            <div>
                <div>
                    <img
                        ...
                        src="https://assets.nflxext.com/ffe/siteui/vlv3/04bef84d-51f6-401e-9b8e-4a521cbce3c5/null/PL-en-20240903-TRIFECTA-perspective_b0ab9ceb-7fef-4efb-911b-e02ad0786bd4_large.jpg" alt="bg" />
                    ...
                    <div className='absolute top-[20%] p-4 md:p-8'>
                        ...
                        <p className='font-nsans-light text-gray-400 text-lg'>{user.email}
                        </p>
                    </div>
                </div>
                {/* movie row */}
                        ...
                        {movies.map((movie) => (
                            ...
                            <div key={movie.id} className='relative w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block rounded-lg overflow-hidden cursor-pointer m-2'>
                                ...
                                <div className='absolute top-0 left-0 w-full h-40 bg-black/80 opacity-0 hover:opacity-100'>
                                    <p className='whitespace-normal text-xs md:text-small flex justify-center items-center h-full font-nsans-bold'>{movie.title}
                                    </p>
